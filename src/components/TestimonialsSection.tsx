...
const testimonials = [
  ...
  },
  {
    ...
    textEn: "Professional and dedicated team. They helped us improve operational processes and significantly increase guest satisfaction.",
  ...
  },
  {
    ...
    textEn: "Innovative marketing strategies and tangible results. We recommend their services to any hotel seeking growth.",
                ...
                <CarouselItem key={index}>
                  <Card className="border-none bg-background shadow-lg">
                    <CardContent className="p-8 md:p-12">
                      ...
                      <p className="text-lg md:text-xl text-foreground mb-4 leading-relaxed" dir="rtl">
                        "{testimonial.text}"
                      </p>
